...
## Пример того как можно учиться на курсе

[Пример последовательности обучения, которая позволит вам намного лучше понять и усвоить материал курса](https://pyneng.github.io/docs/learning_sequence/).
